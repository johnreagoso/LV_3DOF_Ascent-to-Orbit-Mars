function [output_array] = TrajectoryTool_3DOF_GA_Exec_MSFC(x0) 
...
options_coast = odeset('events', 'myEvent3DOF_LMO', 'RelTol',1e-8,'InitialStep', 0.0001,'MaxStep', 5.000);
options       = odeset('events', 'myEvent3DOF_LMO', 'RelTol',1e-8, 'InitialStep',0.0001,'MaxStep', 1.000);
...
vehicleObj_endStep   = state_elements_Mars_Struct(vehicleObj_endStep); %disp(vehicleLast);
...
%output_array = [vehicleObj_endStep.time, vehicleObj_endStep.e, vehicleObj_endStep.apogee_alt, vehicleObj_endStep.apogee_alt,vehicleObj_endStep.incl, vehicleObj_endStep.RAAN, vehicleObj_endStep.SMA];    
